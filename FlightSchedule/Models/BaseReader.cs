...
namespace FlightSchedule.Models {
    public class BaseReader {
        ...
        public BaseReader() {
            string path = (Directory.GetCurrentDirectory().Contains("FlightSchedule") ? "../../.." : "FlightSchedule") + "/Assets/Misc/storage.db";
            ...
            while (reader.Read()) {
                ...
                long day = (long) row[1];
                var obj = Utils.Json2obj((string) row[2]) ?? throw new System.Exception("Ошибка");
